...
private fun ProfileScreenContent(
    ...
    Column(
        ...
        TopBar(
            ...
            profileEditActions = profileEditActions,
            onTotalProgressClick = navigateToRunStats
        )
        Column(
            modifier = Modifier
                .verticalScroll(rememberScrollState())
                .padding(top = 16.dp)
                .padding(bottom = LocalScaffoldBottomPadding.current + 16.dp)
        ) {
            ElevatedCard(
                modifier = Modifier
                    .padding(8.dp)
                ...
                Column(
                    ...
                    SettingsItem(
                        ...
                        title = stringResource(R.string.personal_parameter),
                        onClick = {
                    ...
                    SettingsItem(
                        ...
                        onClick = {
                            Destination.navigateToAchievementsScreen(navController)
                        }
                    )
                    SettingsItem(
                    ...
                    SettingsItem(
                        ...
                        showDivider = false,
                        onClick = {
                            Destination.navigateToContactScreen(navController)
                        }
                    )
                }
            }
            ...
            ElevatedCard(
                ...
                Row(
                    modifier = Modifier
                        .fillMaxWidth()
                        .clickable { profileEditActions.toggleDemoMode() }
                    ...
                    Column(modifier = Modifier.weight(1f)) {
                        ...
                        Text(
                            text = if (profileScreenState.isDemoMode) "Enabled — real tracking paused" else "Show simulated data",
                            style = MaterialTheme.typography.bodySmall.copy(
                                color = if (profileScreenState.isDemoMode)
                    ...
                    androidx.compose.material3.Switch(
                        checked = profileScreenState.isDemoMode,
                        onCheckedChange = { profileEditActions.toggleDemoMode() }
                    )
                }
            }
        }
