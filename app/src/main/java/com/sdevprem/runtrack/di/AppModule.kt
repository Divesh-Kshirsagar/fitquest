...
import com.sdevprem.runtrack.data.tracking.sensor.DefaultStepCounterSensor
import dagger.Binds
...
abstract class AppModule {
    ...
    @Binds
    @Singleton
    abstract fun provideH3Repository(
        h3Repository: com.sdevprem.runtrack.data.repository.DefaultH3Repository
    ): com.sdevprem.runtrack.data.repository.H3Repository
    ...
    @Binds
    @Singleton
    abstract fun provideStepCounterSensor(
        sensor: DefaultStepCounterSensor
    ): StepCounterSensor
