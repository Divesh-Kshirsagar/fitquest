...
## Corpus Check
- 101 files · ~25,600 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 657 nodes · 1113 edges · 42 communities (37 shown, 5 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 19 edges (avg confidence: 0.53)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `eafc6033`
...
Cohesion: 0.09
Nodes (21): HexGeoJsonMapper, HexIndexer, HeatmapResponse, HexDetailResponse, MapViewportResponse, RunSyncPayload, RunSyncSummary, CaptureScreenModel (+13 more)
...
Cohesion: 0.10
Nodes (12): Application, CapturedHexEntity, HexDao, Flow, HexRepository, Flow, RoomHexRepository, FitQuestApi (+4 more)
...
Cohesion: 0.22
Nodes (8): 1. Local Database & Domain Persistence Layer, 2. Onboarding & Profile Setup Flow, 3. Home Dashboard (`HomeTab.kt`), 4. Enhanced Run & Post-Run Experience (`CurrentRunScreen.kt`), 5. Leaderboard & District Rankings (`LeaderboardTab.kt`), 6. Profile, Achievements & Settings (`ProfileTab.kt`), 7. Verification & Testing, Implementation Plan: Offline Frontend Sprint

### Community 35 - "FitQuest"
Cohesion: 0.22
Nodes (9): Architecture, Documentation, FitQuest, Getting Started, H3 Native Libraries, How It Works, License, Prerequisites (+1 more)
...
### Community 39 - "Emulator & Testing Notes"
Cohesion: 0.40
Nodes (5): Emulator & Testing Notes, Grid Ring Size, H3 Resolution, Location on Emulator, Step Counter Sensor

### Community 40 - "Similar Apps & References"
Cohesion: 0.50
Nodes (4): Commercial & Community Precedents, High-Value Feature Roadmap (Derived from Precedents), Open-Source Implementations & Geospatial Tooling, Similar Apps & References

## Knowledge Gaps
- **102 isolated node(s):** `HexDetailResponse`, `HeatmapResponse`, `Codebase Metadata`, `Backend SQLModel Entities`, `Mobile Persistence Schema (Room)` (+97 more)
...
- **Why does `HexRepository` connect `AppModule.kt` to `UserProfileEntity`, `GeoPoint`, `HomeTab.kt`, `CaptureScreenModel.kt`?**
